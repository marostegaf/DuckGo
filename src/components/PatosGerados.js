...
import PainelLateral from "./painelLateral/painelLateral"; // Importa o painel
...
export default function PatosGerados({ basePosicao }) {
  ...
  return (
    <div style={{ height: "100%", position: "relative" }}>
      {/* Painel lateral */}
      <PainelLateral aberto={!!patoSelecionado} onFechar={() => setPatoSelecionado(null)}>
        {patoSelecionado && <InformacaoObtida pato={patoSelecionado.pato} drone={patoSelecionado.drone} />}
      </PainelLateral>
